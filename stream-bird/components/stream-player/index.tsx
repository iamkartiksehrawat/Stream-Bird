  ...
  return (
    <>
      ...
      <LiveKitRoom
        ...
        className={cn(
          "grid grid-cols-1 lg:gap-y-0 lg:grid-cols-3 h-full p-4 pt-6 gap-4",
...
export const StreamPlayerSkeleton = () => {
  return (
    <div className="grid grid-cols-1 lg:gap-y-0 lg:grid-cols-3 h-full p-4 pt-6 gap-4">
      <div className="space-y-4 col-span-2 pb-10">
        <VideoSkeleton />
        <HeaderSkeleton />
      </div>
